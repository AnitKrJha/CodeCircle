        ...
        <div className="mx-auto w-full max-w-lg space-y-6">
          <div className="space-y-4">
            ...
            <p className="text-muted-foreground">
              Pools are like lockers where you can keep your favourite questions
              and invite your friends to view and solve.
            </p>
          </div>
          <CreatenewProblem poolId={params.poolid} />
          <div className="flex items-center justify-center">
            <Button asChild variant={"link"} size={"sm"}>
              <Link href="/dashboard/my-problems" prefetch={false}>
                <ArrowLeftSquare size={16} className="mr-2" /> Back to Your
                Problems
              </Link>
            </Button>
          </div>
